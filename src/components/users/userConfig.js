export default function userConfig(orgIDs, orgNames, existing=null){
    ...
    if(!existing){
        ...
        {name: 'organization', label: 'User Organization', type: 'select',  required: true, value: existing?.organization_id ? existing.organization_id : '',
            constructors: {
                values: orgIDs,
                labels: orgNames,
                multiple: false,
        ...
        {name: 'role', label: 'User Role', type: 'select',  required: true, value: existing?.role ? existing.role : '',
            constructors: {
                values: roles,
                labels: roleNames,
                multiple: false,
