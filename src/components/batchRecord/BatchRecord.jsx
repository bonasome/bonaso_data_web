    ...
    return(
        <div className={styles.fileUpload}>
            ...
            <div className={styles.template}>
                ...
                <p>
                    Use this page to download and Excel templates for an assessment. After filling out the template,
                    you can then upload that template right here as well and the data will appear in our system.
                </p>
                <p>Easy as that!</p>
            </div>
            <div className={styles.template}>
                <h3>1. Select your organization and the project to get a ready-to-use template for recording data. There are directions and examples in the template for your reference.</h3>
            ...
            <div className={styles.upload}>
                <h3>2. Upload your completed file. If there are any issues, you will be informed and can try to upload again. </h3>
